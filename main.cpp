...
RPiGPIOPin cs = RPI_GPIO_P1_22;
RPiGPIOPin dio0 = RPI_GPIO_P1_07;
RPiGPIOPin rst = RPI_GPIO_P1_11;
...
#define SERVER1 "40.114.249.243"    // The Things Network: croft.thethings.girovito.nl
...
byte readRegister(byte addr)
{
    ...
    spibuf[0] = addr & 0x7F;
    spibuf[1] = 0x00;
    bcm2835_spi_transfern(spibuf, 2);
    unselectreceiver();
